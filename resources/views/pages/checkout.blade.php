          ...
          <div class="card card-details">
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="{{ route('checkout_remove', $detail->id) }}">
                          <img src="{{ url('frontend/images/ic_delete.png') }}">
                        </a>
                      </td>
                    </tr>
                  @empty
            ...
            <div class="member mt-3">
              ...
              <form class="form-inline" method="POST" action="{{ route('checkout_create', $item->id) }}">
                ...
                <input type="text" name="nationality" class="form-control mb-2 mr-sm-2" style="width:100px" id="nationality"
                ...
                <div class="input-group mb-2 mr-sm-2">
                  ...
                  id="doe_passport" name="doe_passport" placeholder="DOE Passport" style="width:150px">
                </div>
              ...
              <p class="disclaimer mb-0">
                You are only able to invite member that has registered in Godream.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card card-details card-right">
            ...
            <table class="trip-information">
              ...
              <tr>
                <th width="40%" class="text-code-unique">Total (+Unique Code)</th>
                <td width="60%" class="text-right text-total">
                  <span class="text-blue">Rp {{number_format($item->transaction_total,0,',','.')}}</span><span class="text-orange"></span>
                </td>
              </tr>
            </table>
            <hr>
            <h2>Paymeny Instructions</h2>
            <p class="payment-instruction">
              Kamu akan diarahkakn kehalaman pembayaran menggunakan Go-PAY
            </p>
